...
public class RemovePatient extends javax.swing.JFrame {
   ...
   private void loadAllPatientList(){
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(RemovePatient.class.getResource("hms.png")));
        ...
        txtGreetings.setText("                                       Remove Patient");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\g\\Desktop\\lecture\\project java\\icon\\Receptionist.jpg")); // NOI18N
        ...
        jPanel6.add(jcbPatId, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 190, 130, 30));
    ...
    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        ...
        boolean result;
        try {
            result = PatientDao.removePatient(id);
            if(result){
                JOptionPane.showMessageDialog(null,"Patient Removed Successfully");
                loadAllPatientList();
            }
            else   JOptionPane.showMessageDialog(null,"Patient Not removed");
