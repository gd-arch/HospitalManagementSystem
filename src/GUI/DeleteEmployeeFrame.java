...
HashMap <String,String> emplist;
    private void loadEmployeeDetails(){
      try {
          emplist=EmpDao.getNonRegisteredEmployeeList();
          if(emplist.size()==0){
              btnDelete.setEnabled(false);
               JOptionPane.showMessageDialog(null,"No Unregistered employee to delete!");
               return;
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(DeleteEmployeeFrame.class.getResource("hms.png")));
        ...
        txtGreetings.setText("                                       Delete Employee");
        ...
        jPanel6.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 440, 80, 40));
...
ManageEmployeeFrame manage=new ManageEmployeeFrame();
  ...
  loadEmployeeDetails();
           ...
           JOptionPane.showMessageDialog(null,"SQL Exception in Deleting Employee"+ex,"ERROR!",JOptionPane.ERROR_MESSAGE);
        }
...
txtEmpName.setText(emplist.get(jcbEmpId.getSelectedItem().toString()));        // TODO add your handling code here:
