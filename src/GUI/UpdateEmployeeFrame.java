  ...
  public boolean validateInput(){
          ...
          emplist=EmpDao.getEmployeeList();
           if(emplist.size()==0){
              btnUpdateEmp.setEnabled(false);
               JOptionPane.showMessageDialog(null,"No unregistered employee to update!");
               return;

          }
          Collection c=emplist.keySet();
          Iterator <String> itr=c.iterator();
          jcbEmpId.removeAllItems();
          while(itr.hasNext()){
              String key=itr.next();
              jcbEmpId.addItem(key);
        }
  
      } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,"SQL Exception in loading Employee details","ERROR!",JOptionPane.ERROR_MESSAGE);
      }
    }
   ...
   jcbJob.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(UpdateEmployeeFrame.class.getResource("hms.png")));
        ...
        txtGreetings.setText("                                       Update Employee");
        ...
        jPanel6.add(btnUpdateEmp, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 470, 80, 40));
    ...
    private void btnUpdateEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateEmpActionPerformed
     try {
         if (!validateInput()){
             JOptionPane.showMessageDialog(null,"please enter salary","ERROR!",JOptionPane.ERROR_MESSAGE);
             return;
         }
         EmpPojo emp=new EmpPojo();
         emp.setEmpid(jcbEmpId.getSelectedItem().toString());
         emp.setEmpname(txtEmpName.getText());
         emp.setJob(jcbJob.getSelectedItem().toString());
      ...
      clearText();
              loadEmployeeDetails();
         }else  JOptionPane.showMessageDialog(null,"Record  Not Updated ");
         
     } catch (SQLException ex) {
         JOptionPane.showMessageDialog(null,"SQL Exception in updating Employee","ERROR!",JOptionPane.ERROR_MESSAGE);
     }
...
if(jcbEmpId.getSelectedItem()==null || jcbEmpId.getItemCount()==0){
    return;
}
txtEmpName.setText(emplist.get(jcbEmpId.getSelectedItem().toString()));
